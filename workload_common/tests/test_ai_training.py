...
from workload_common.models.ai_training import BIN_COUNT, GROUP_UNITS, PHASES, RANK_COUNT, RANK_SPANS, render
...
class AiTrainingModelTests(unittest.TestCase):
    ...
    def test_both_layouts_render_five_training_phases(self) -> None:
        for layout, capacity, fwd_count, total_fwd_count in (
            (SINGLE_LAYOUT, 112 * 1024 + 512, 120, 600),
            (SYSU_LAYOUT, 750 * 1024, 200, 1000),
        ):
