# INSPUR AI 训练数据与 checkpoint 负载

这是 INSPUR 套件中 3000 GiB 的 AI 训练物理版本。来源与适用范围见
...
|---|---:|---:|---:|---:|
| `dataset` | 2,000 | 2500 GiB | 100 | 40 |
| `checkpoint_current` | 200 | 250 GiB | 100 | 40 |
| `checkpoint_old` | 200 | 250 GiB | 100 | 40 |
...
单独保留、后80个每4个合并压缩为40个bin。dataset头部/尾部bin为25/100 GiB，
checkpoint为2.5/10 GiB。写阶段覆盖 prepare 已创建的 current checkpoint，
