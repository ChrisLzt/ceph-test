#!/usr/bin/env python3
"""INSPUR wrapper for the shared AI training model."""
...
def render(*, anchor_root: str, output_dir: Path, threads: int = 1, dataset_phase_seconds: int = 160, checkpoint_phase_seconds: int = 60, fwdrate: str = "max") -> None:
    render_model(layout=INSPUR_LAYOUT, anchor_root=anchor_root, output_dir=output_dir, threads=threads, dataset_phase_seconds=dataset_phase_seconds, checkpoint_phase_seconds=checkpoint_phase_seconds, fwdrate=fwdrate)
    update_run_config(
