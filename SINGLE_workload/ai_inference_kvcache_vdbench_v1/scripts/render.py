#!/usr/bin/env python3
"""Single-node wrapper for the shared AI inference model."""
...
def render(*, anchor_root: str, output_dir: Path, host: str, remote_user: str, vdbench_home: str, threads: int = 1, phase_seconds: int = 100, fwdrate: str = "max") -> None:
